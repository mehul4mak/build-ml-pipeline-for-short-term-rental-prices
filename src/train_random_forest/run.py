...
def go(args):
    ...
    export_model(run, sk_pipe, X_val, y_pred, args.output_artifact, rf_config)
...
def export_model(run, pipe, X_val, val_pred, export_artifact,rf_config):

    # Infer the signature of the model
    
    signature = mlflow.models.infer_signature(X_val, val_pred)
